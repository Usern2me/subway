...
(function () {
    ...
    var AlloyTouch = function (option) {
        ...
        this.friction = this._getValue(option.friction, 1);
    ...
    AlloyTouch.prototype = {
            ...
            if (this.isTouchStart) {
                ...
                if (this.hasMax && current > this.max) {
                    ...
                    if (dt < 300) {
                        ...
                        var duration = Math.round(speed2 / self.deceleration) * tRatio * (1/this.friction);
                        console.log(speed2, duration, this.friction);
                        ...
                        // 这里是没有滑动时出发；改造后也算animationEnd;但是没有value返回。
        ...
        _to: function (value, time, ease, onChange, onEnd) {
            ...
            var toTick = function () {
                ...
                //cancelAnimationFrame蹇呴』鍦� tickID = requestAnimationFrame(toTick);鐨勫悗闈�
